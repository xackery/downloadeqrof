...
namespace ROF_Downloader
{
    internal class Database
    {
        ...
        public static async void Fix(bool fixAll)
        {
            ...
            stage = await UtilityLibrary.Download(40, 80, "https://raw.githubusercontent.com/xackery/downloadeqrof/main/launcher/Assets/portable_settings.txt", "db\\heidi", "portable_settings.txt", 1);
            if (stage == -1) { return; }
            if (!fixAll && stage > startStage) { return; }
        }
